        ...
        <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-8">
          ...
          <div className="relative z-10 max-w-xl">
            ...
            <h1 className="font-serif text-4xl font-bold leading-[1.1] tracking-tight text-foreground sm:text-5xl lg:text-6xl xl:text-[4.5rem]">
              ...
              <span className="block">
                <span className="text-foreground">Workforce</span> Here
              </span>
            </h1>
          ...
          <div className="relative lg:h-[600px]">
            ...
            <div className="relative h-full">
              ...
              <div className="absolute bottom-0 right-0 h-[90%] w-[85%] rounded-[3rem] border border-border bg-muted/40" />
              ...
              <div className="absolute -left-4 top-8 z-20 rounded-2xl border border-border bg-card px-5 py-4 shadow-sm sm:left-0 lg:-left-12">
              ...
              <div className="absolute -right-4 top-1/3 z-20 rounded-2xl border border-border bg-card px-5 py-4 shadow-sm sm:right-0 lg:-right-8">
                <div className="flex items-center gap-4">
                  <div className="flex h-12 w-12 items-center justify-center rounded-full bg-muted">
              ...
              <div className="absolute -left-4 bottom-24 z-20 rounded-2xl border border-border bg-card px-5 py-4 shadow-sm sm:left-0 lg:-left-8">
                <div className="flex items-center gap-4">
                  <div className="flex h-12 w-12 items-center justify-center rounded-full bg-muted">
                    <svg className="h-6 w-6 text-foreground" fill="none" viewBox="0 0 24 24" stroke="currentColor">
